...
const FeaturedRooms: React.FC<FeaturedRoomsProps> = ({ FeaturedRoom }) => {
    ...
    return <section className='flex md:flex-row flex-col px-4 py-10 items-center gap-12 container mx-auto'>
        ...
        <div className='md:py-10 md:w-1/2 text-left'>
            <h3 className='font-heading mb-12'>Featured Rooms</h3>
            <p className='font-normal max-w-md'>{FeaturedRoom
                .description}</p>
